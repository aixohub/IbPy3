...
class CommissionReport(Object):
    ...
    def __str__(self):
        return "ExecId: %s, Commission: %s, Currency: %s, RealizedPnL: %s, Yield: %s, YieldRedemptionDate: %s" % (
            self.execId,
            floatMaxString(self.commission), self.currency, floatMaxString(self.realizedPNL),
