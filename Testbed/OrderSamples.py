...
class OrderSamples:
    ...
    @staticmethod
    def PegBestUpToMidOrder(action: str, quantity: Decimal, limitPrice: float, minTradeQty: int, minCompeteSize: int,
                            midOffsetAtWhole: float, midOffsetAtHalf: float):
    ...
    @staticmethod
    def PegBestOrder(action: str, quantity: Decimal, limitPrice: float, minTradeQty: int, minCompeteSize: int,
    ...
    @staticmethod
    def PegMidOrder(action: str, quantity: Decimal, limitPrice: float, minTradeQty: int, midOffsetAtWhole: float,
